...
plt.plot(measurement_mpc['time'], measurement_mpc['fcu.uFan'],c=COLORS[1], label='MPC:PH=96')
...
plt.plot(measurement_mpc['time'],  measurement_mpc['TRoo']-273.15,c=COLORS[1], label='MPC:PH=96')
...
plt.plot(measurement_mpc['time'], measurement_mpc['PTot'], c=COLORS[1], label='MPC:PH=96')
