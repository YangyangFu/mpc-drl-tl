...
def run_demo(with_plots=True):
   ...
   (3.) If with_plots is True we compile the same optimization problem again 
    ...
    number_samp_tot = int(finalTime/sample_period)
    ...
    if with_plots:
        ...
        open_loop_opts = op.optimize_options()
        open_loop_opts['n_e'] = n_e
        open_loop_opts['n_cp'] = 2
        open_loop_opts['init_traj'] = init_res
        open_loop_opts['blocking_factors'] = bf
