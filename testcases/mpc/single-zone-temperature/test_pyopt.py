...
# Instantiate Optimizer (PSQP) & Solve Problem - works
psqp = PSQP()
...
# Instantiate Optimizer (SOLVOPT) & Solve Problem - works
solvopt = SOLVOPT()
...
# Instantiate Optimizer (NSGA2) & Solve Problem -works
nsga2 = NSGA2()
nsga2.setOption('PrintOut',0)
nsga2(opt_prob)
print opt_prob.solution(6)

# Instantiate Optimizer (ALGENCAN) & Solve Problem -works
algencan = ALGENCAN()
