within ;
package FiveZoneSim "Five zone VAV supervisory control"
  model SystemBaseline "System example for fault injection"
    extends Modelica.Icons.Example;
    extends FiveZoneSim.BaseClasses.PartialHotWaterside(
    ...
    extends FiveZoneSim.BaseClasses.PartialAirside(
      fanSup(show_T=false),
      conAHU(
        pNumIgnReq=1,
        TSupSetMin=284.95,
      ...
      conVAVNor(
        ...
        errTZonCoo_1=0.8,
        errTZonCoo_2=0.4));
    extends FiveZoneSim.BaseClasses.PartialWaterside(
      redeclare
    ...
    extends FiveZoneSim.VAVReheat.BaseClasses.ZoneAirTemperatureDeviation(
        banDevSum(each uppThreshold=24.5 + 273.15, each lowThreshold=23.5 +
            273.15));

    extends FiveZoneSim.BaseClasses.EnergyMeter(
    ...
    Modelica.Blocks.Sources.RealExpression yVal5(y=if chiPlaEnaDis.yPla == true
           then 1 else 0)
      "On/off signal for valve 5"
      annotation (Placement(transformation(extent={{1060,-192},{1040,-172}})));
    Modelica.Blocks.Sources.RealExpression yVal6(y=0)
    ...
    FiveZoneSim.Controls.PlantRequest plaReqChi
      annotation (Placement(transformation(extent={{1044,-120},{1064,-100}})));
    FiveZoneSim.Controls.ChillerPlantEnableDisable chiPlaEnaDis(yFanSpeMin=0.15,
        plaReqTim=30*60)
    ...
    FiveZoneSim.Controls.BoilerPlantEnableDisable boiPlaEnaDis(
      yFanSpeMin=0.15,
      plaReqTim=30*60,
      TOutPla=291.15)
    ...
    FiveZoneSim.Controls.PlantRequest plaReqBoi
  ...
  equation
    ...
    connect(TCWSup.T, cooTowSpeCon.TCWSup) annotation (Line(points={{828,-305},
            {828,-64},{1274,-64},{1274,-99.1111},{1286,-99.1111}},
          color={0,0,127}));
    ...
    connect(cooTowSpeCon.y, cooTow.y) annotation (Line(points={{1309,-99.1111},
            {1402,-99.1111},{1402,-344},{722,-344},{722,-308},{736,-308}},
                                                                        color={0,
            0,127}));
    ...
    connect(chiPlaEnaDis.yPla, temDifPreRes.uOpeMod) annotation (Line(points={{
            1121,-110},{1132,-110},{1132,-200},{1078,-200},{1078,-237},{1088,
            -237}}, color={255,0,255}));
    connect(chiPlaEnaDis.yPla, cooTowSpeCon.cooMod) annotation (Line(points={{
            1121,-110},{1132,-110},{1132,-95.3778},{1286,-95.3778}}, color={255,
            0,255}));
    connect(chiPlaEnaDis.yPla, chiStaCon.cooMod) annotation (Line(points={{1121,
            -110},{1138,-110},{1138,-134},{1232,-134},{1232,-122},{1284,-122}},
          color={255,0,255}));
    connect(chiPlaEnaDis.yPla, wseOn.u) annotation (Line(points={{1121,-110},{
            1136,-110},{1136,-154},{1324,-154}}, color={255,0,255}));
    connect(chiPlaEnaDis.yPla, CWPumCon.cooMod) annotation (Line(points={{1121,
            -110},{1134,-110},{1134,-204},{1282,-204}}, color={255,0,255}));
    connect(chiPlaEnaDis.yPla, pumSpe.trigger) annotation (Line(points={{1121,
            -110},{1160,-110},{1160,-266},{1342,-266},{1342,-260}}, color={255,
            0,255}));
    annotation (
  ...
  model wrappedcool "Wrapped model for cooling case"
   ...
   // Original model
   FiveZoneSim.SystemCoolSeasonBaseline modCoo(
      ...
      oveActdp(uExt(y=oveAct_dpSet), activate(y=true)))
  ...
  package VAVReheat "Variable air volume flow system with terminal reheat and five thermal zone"
    ...
    model Guideline36
      ...
      extends Modelica.Icons.Example;
      extends FiveZoneSim.VAVReheat.BaseClasses.PartialOpenLoop;
...
constructed by the signals connected to this bus.
      ...
      block CoolingCoilTemperatureSetpoint "Set point scheduler for cooling coil"
        ...
        import FiveZoneSim.VAVReheat.Controls.OperationModes;
...
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/602\">#602</a>.
      ...
      model ModeSelector "Finite State Machine for the operational modes"
        ...
        State unOccOff(
          mode=FiveZoneSim.VAVReheat.Controls.OperationModes.unoccupiedOff,
          nIn=3,
          nOut=4) "Unoccupied off mode, no coil protection"
          annotation (Placement(transformation(extent={{-20,20},{0,40}})));
        State unOccNigSetBac(
          nOut=2,
          mode=FiveZoneSim.VAVReheat.Controls.OperationModes.unoccupiedNightSetBack,
        ...
        State morWarUp(mode=FiveZoneSim.VAVReheat.Controls.OperationModes.unoccupiedWarmUp,
                                                                                  nIn=2,
        ...
        State occ(       mode=FiveZoneSim.VAVReheat.Controls.OperationModes.occupied,
                                                                            nIn=3)
          "Occupied mode"
        ...
        State morPreCoo(
          nIn=1,
          mode=FiveZoneSim.VAVReheat.Controls.OperationModes.unoccupiedPreCool,
...
Removed blocks with blocks from CDL package.
    ...
    at disable to avoid pressure fluctuations"
        ...
        FiveZoneSim.VAVReheat.Controls.SupplyTemperature supTemSetPoi(
          final samplePeriod=samplePeriod,
...
First implementation.
    ...
    at disable to avoid pressure fluctuations"
        ...
        FiveZoneSim.VAVReheat.Controls.SupplyTemperatureOve supTemSetPoi(
          final samplePeriod=samplePeriod,
          final TSupSetMin=TSupSetMin,
          final TSupSetMax=TSupSetMax,
          final TSupSetDes=TSupSetDes,
...
First implementation.
      ...
      package Examples "Example models to test the components"
        ...
        model OperationModes "Test model for operation modes"
            extends Modelica.Icons.Example;
          import ModelicaVAV = FiveZoneSim.VAVReheat;
...
This model tests the transition between the different modes of operation of the HVAC system.
        ...
        model RoomVAV "Test model for the room VAV controller"
          ...
          FiveZoneSim.VAVReheat.Controls.RoomVAV vavBoxCon
...
as a control signal.
    ...
    package Validation "Collection of validation models"
      ...
      model Guideline36SteadyState
        ...
        extends FiveZoneSim.VAVReheat.Guideline36(
          weaDat(
...
does not include the flow resistance of the air damper.
      ...
      //    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
        ...
        FiveZoneSim.VAVReheat.ThermalZones.VAVBranch cor(
        ...
        FiveZoneSim.VAVReheat.ThermalZones.VAVBranch sou(
          redeclare package MediumA = MediumA,
          redeclare package MediumW = MediumW,
        ...
        FiveZoneSim.VAVReheat.ThermalZones.VAVBranch eas(
          redeclare package MediumA = MediumA,
          redeclare package MediumW = MediumW,
        ...
        FiveZoneSim.VAVReheat.ThermalZones.VAVBranch nor(
          redeclare package MediumA = MediumA,
          redeclare package MediumW = MediumW,
        ...
        FiveZoneSim.VAVReheat.ThermalZones.VAVBranch wes(
          redeclare package MediumA = MediumA,
          redeclare package MediumW = MediumW,
        ...
        Buildings.Fluid.Sensors.VolumeFlowRate VSupWes_flow(
          ...
          allowFlowReversal=allowFlowReversal) "Discharge air flow rate" annotation (
            Placement(transformation(
              ...
              rotation=90,
              origin={1300,128})));
        FiveZoneSim.VAVReheat.BaseClasses.MixingBox eco(
          redeclare package Medium = MediumA,
    ...
    the water plant system (assume constant for differt loads)";
      ...
      partial model ZoneAirTemperatureDeviation
        "Calculate the zone air temperature deviation outside the boundary"
         ...
         FiveZoneSim.VAVReheat.BaseClasses.BandDeviationSum banDevSum[5](each
      ...
      block BandDeviationSumTest
        ...
        FiveZoneSim.VAVReheat.BaseClasses.BandDeviationSum bandDevSum(
...
<a href=\"modelica://Buildings.Examples.VAVReheat\">Buildings.Examples.VAVReheat</a>.
  ...
  package BaseClasses
    ...
    model IntegratedPrimaryLoadSide
      ...
      extends FiveZoneSim.BaseClasses.PartialIntegratedPrimary(final
...
First implementation.
    ...
    partial model PartialWaterside
     ...
     // WSE parameters
      ...
      parameter FiveZoneSim.Data.Chiller[numChi] perChi(
      ...
      FiveZoneSim.Controls.ChillerStage chiStaCon(tWai=0)
      ...
      FiveZoneSim.Controls.ConstantSpeedPumpStage CWPumCon(tWai=0)
      ...
      FiveZoneSim.Controls.CoolingTowerSpeed cooTowSpeCon(
        controllerType=Modelica.Blocks.Types.SimpleController.PI,
        yMin=0,
        Ti=60,
        k=0.1) "Cooling tower speed control"
        annotation (Placement(transformation(extent={{1288,-108},{1308,-92}})));
      ...
      FiveZoneSim.Controls.TemperatureDifferentialPressureReset temDifPreRes(
    ...
    equation
      ...
      connect(TCWSupSet.y,cooTowSpeCon. TCWSupSet)
        annotation (Line(
          points={{1217,-90},{1252,-90},{1252,-92},{1286,-92}},
          color={0,0,127}));
...
First implementation.
    ...
    partial model PartialHotWaterside
      ...
      FiveZoneSim.Controls.MinimumFlowBypassValve minFloBypHW(controllerType=
      ...
      FiveZoneSim.Controls.TrimResponse triResHW(
        uTri=0.9,
  ...
  thermal zones: this is a copy of Buildings.Examples.VAVReheat.BaseClasses.PartialOpenLoop"
    ...
    //    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
      ...
      Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather Data Bus"
        annotation (Placement(transformation(extent={{-330,170},{-310,190}}),
            iconTransformation(extent={{-360,170},{-340,190}})));
      FiveZoneSim.VAVReheat.ThermalZones.Floor flo(
        redeclare final package Medium = MediumA,
        final lat=lat,
        final use_windPressure=use_windPressure,
        final sampleModel=sampleModel)
...
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/426\">issue 426</a>.
    ...
    partial model PartialAirside
      "Variable air volume flow system with terminal reheat and five thermal zones"
      extends FiveZoneSim.BaseClasses.PartialPhysicalAirside(heaCoi(dp1_nominal=
             30000));
      ...
      Buildings.Controls.OBC.CDL.Routing.RealReplicator reaRep(
        ...
        "Replicate real input"
        annotation (Placement(transformation(extent={{-120,320},{-100,340}})));
      FiveZoneSim.VAVReheat.Controls.ControllerOve conAHU(
        final pMaxSet=410,
        final yFanMin=yFanMin,
        final VPriSysMax_flow=VPriSysMax_flow,
  ...
  package Controls
    ...
    model ChillerStage "Chiller staging control logic"
      ...
      Modelica.StateGraph.Transition con1(
        enableTimer=true,
        waitTime=tWai,
        condition=cooMod == true) "off to on"
        annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=-90,
            origin={-50,42})));
      ...
      Modelica.StateGraph.Transition con2(
        enableTimer=true,
        waitTime=tWai,
        condition=cooMod == false) "on to off"
        annotation (Placement(transformation(
            extent={{10,-10},{-10,10}},
            rotation=-90,
            origin={-20,52})));
      ...
      Buildings.Controls.OBC.CDL.Conversions.BooleanToReal    booToRea
        annotation (Placement(transformation(extent={{20,-10},{40,10}})));
      Modelica.Blocks.Interfaces.BooleanInput cooMod
        "Connector of Boolean input signal"
        annotation (Placement(transformation(extent={{-140,40},{-100,80}})));
    equation
      ...
      connect(con2.outPort, off.inPort[1])
        annotation (Line(
          ...
          color={0,0,0},
          pattern=LinePattern.Dash));
      connect(con2.inPort, oneOn.outPort[2])
        annotation (Line(
...
First implementation.
    ...
    For boiler plant, it is normally 18°C";
      ...
      FiveZoneSim.Controls.BaseClasses.TimeLessEqual lesEquReq(threshold=numIgn)
...
<li>Aug 30, 2020, by Xing Lu:<br>First implementation. </li>
    ...
    model CoolingMode
      ...
      Modelica.Blocks.MathInteger.MultiSwitch swi(
        y_default=0,
        expr={Integer(FiveZoneSim.Types.CoolingModes.FreeCooling),
            Integer(FiveZoneSim.Types.CoolingModes.PartialMechanical),
            Integer(FiveZoneSim.Types.CoolingModes.FullMechanical),
            Integer(FiveZoneSim.Types.CoolingModes.Off)},
        nu=4)
...
First implementation.
    ...
    model ConstantSpeedPumpStage "Staging control for constant speed pumps"
      ...
      Modelica.StateGraph.StepWithSignal oneOn(nIn=2, nOut=2)
        "One chiller is commanded on" annotation (Placement(transformation(
            ...
            rotation=-90,
            origin={-40,10})));
      Modelica.StateGraph.InitialStep off(nIn=1) "off"
        annotation (Placement(transformation(
            extent={{-10,10},{10,-10}},
            rotation=-90,
            origin={-40,70})));
      ...
      Modelica.StateGraph.Transition con2(
        enableTimer=true,
        waitTime=tWai,
        condition=cooMod == true and numOnChi > 1)
      ...
      Modelica.StateGraph.Transition con3(
        enableTimer=true,
        waitTime=tWai,
        condition=cooMod == true and numOnChi < 2)
    ...
    equation
      ...
      annotation (                   Documentation(info="<html>
<p>This model describes a simple staging control for two constant-speed pumps in a chilled water plant with two chillers. The staging sequence is shown as below. </p>
<ul>
<li>The number of running constant speed pumps equals to the number of running chillers. </li>
</ul>
</html>",     revisions="<html>
<ul>
<li>
...
First implementation.
    ...
    protected
      Modelica.Blocks.Logical.Switch swi "Switch" annotation (Placement(
            transformation(extent={{-10,-10},{10,10}}, origin={64,38})));
    equation
      connect(swi.y, y) annotation (Line(points={{75,38},{96,38},{96,0},{110,0}},
            color={0,0,127}));
      connect(TCWSupSet, conPID.u_s)
        annotation (Line(points={{-120,80},{-12,80}}, color={0,0,127}));
      connect(TCWSup, conPID.u_m) annotation (Line(points={{-120,8.88178e-16},{
              0,8.88178e-16},{0,68}}, color={0,0,127}));
      connect(swi.u2, cooMod) annotation (Line(points={{52,38},{-26,38},{-26,42},
              {-120,42}}, color={255,0,255}));
      connect(conPID.y, swi.u1) annotation (Line(points={{11,80},{38,80},{38,46},
              {52,46}}, color={0,0,127}));
      connect(off.y, swi.u3) annotation (Line(points={{9,-20},{28,-20},{28,30},
              {52,30}}, color={0,0,127}));
      connect(cooMod, conPID.trigger) annotation (Line(points={{-120,42},{-8,42},
              {-8,68}}, color={255,0,255}));
      annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,
                -100},{100,80}})),    Documentation(info="<html>
<p>This model describes a simple cooling tower speed controller for a chilled water system. </p>
<p>The control logics are described in the following:</p>
<ul>
<li>When the system is in Fully Mechanical Cooling mode, the cooling tower fan speed is controlled to maintain the condener water supply temperature (CWST) at or around the setpoint. </li>
</ul>
</html>",     revisions="<html>
<ul>
<li>
...
First implementation.
    ...
    model TemperatureDifferentialPressureReset
      ...
      Modelica.Blocks.Interfaces.RealInput u
        ...
        annotation (Placement(transformation(extent={{-140,-20},{-100,20}})));
      FiveZoneSim.PrimarySideControl.BaseClasses.LinearPiecewiseTwo linPieTwo(
        x0=0,
        x1=x1,
        x2=1,
        y10=dpMin,
      ...
      Modelica.Blocks.Interfaces.RealOutput TSet(
        ...
        annotation (Placement(transformation(extent={{100,-60},{120,-40}}),
            iconTransformation(extent={{100,-60},{120,-40}})));
      FiveZoneSim.PrimarySideControl.BaseClasses.TrimAndRespond triAndRes(
      ...
      Modelica.Blocks.Interfaces.BooleanInput uOpeMod
        "Connector of Boolean input signal"
    ...
    equation
      ...
      connect(swi1.u2, uOpeMod) annotation (Line(points={{58,80},{-16,80},{-16,
              50},{-120,50}}, color={255,0,255}));
      connect(uOpeMod, swi2.u2) annotation (Line(points={{-120,50},{12,50},{12,
...
<li>Sep 1, 2020, by Xing Lu:<br>First implementation. </li>
    ...
    model HotWaterTemperatureReset "Hot Water Temperature Reset Control"
      ...
      FiveZoneSim.Controls.PlantRequest plaReq(uLow=uLow, uHigh=uHigh)
...
<li><i>June 23, 2018</i> by Xing Lu:<br/>
    ...
    package Validation
      ...
      model ChillerPlantEnableDisable
        extends Modelica.Icons.Example;
        FiveZoneSim.Controls.ChillerPlantEnableDisable plaEnaDis
          annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
      ...
      model PlantRequest
        ...
        Modelica.Blocks.Sources.Sine uPlaReq(
          ...
          startTime(displayUnit="min") = 300)
          annotation (Placement(transformation(extent={{-60,-10},{-40,10}})));
        FiveZoneSim.Controls.PlantRequest plaReq
      ...
      model CoolingMode
        ...
        FiveZoneSim.Controls.CoolingMode cooModCon(
          deaBan1=1,
          deaBan2=1,
          tWai=30,
          deaBan3=1,
...
First implementation.
      ...
      model ConstantSpeedPumpStage
        ...
        FiveZoneSim.Controls.ConstantSpeedPumpStage conSpePumSta(tWai=30)
...
First implementation.
      ...
      model CoolingTowerSpeed
        ...
        FiveZoneSim.Controls.CoolingTowerSpeed cooTowSpeCon(controllerType=
              Modelica.Blocks.Types.SimpleController.PI)
...
First implementation.
      ...
      model MinimumFlowBypassValve
        ...
        Modelica.Blocks.Sources.Sine m_flow(
          ...
          startTime(displayUnit="min") = 60)
          annotation (Placement(transformation(extent={{-60,10},{-40,30}})));
        FiveZoneSim.Controls.MinimumFlowBypassValve minFloBypVal(m_flow_minimum=
      ...
      model HotWaterTemperatureReset
        ...
        Modelica.Blocks.Sources.Sine yVal(
          ...
          annotation (Placement(transformation(extent={{-60,-30},{-40,-10}})));
        FiveZoneSim.Controls.HotWaterTemperatureReset hotWatTemRes(resAmo=2)
    ...
    extends Modelica.Icons.Package;
      ...
      model StageLoadBasedChiller
        ...
        Modelica.Blocks.Sources.BooleanExpression unOccFre(y=uOpeMod == Integer(
              FiveZoneSim.Types.CoolingModes.Off)
               or uOpeMod == Integer(FiveZoneSim.Types.CoolingModes.FreeCooling))
    ...
    extends Modelica.Icons.Package;
      ...
      model MaximumSpeedFan
        ...
        Modelica.Blocks.Sources.BooleanExpression FreOrFul(y=uOpeMod == Integer(
              FiveZoneSim.Types.CoolingModes.FreeCooling)
               or uOpeMod == Integer(FiveZoneSim.Types.CoolingModes.FullMechanical))
        ...
        Modelica.Blocks.Sources.BooleanExpression Pmc(y=uOpeMod == Integer(
              FiveZoneSim.Types.CoolingModes.PartialMechanical))
...
(3) CW system differential pressure PID output signal. 
      ...
      model SupplyTemperatureReset
        ...
        Modelica.Blocks.Sources.BooleanExpression fmcMod(y=uOpeMod == Integer(
              FiveZoneSim.Types.CoolingModes.FullMechanical))
        ...
        Modelica.StateGraph.Transition tra2(
          ...
          "Transition 1"
           annotation (Placement(
              ...
              rotation=-90,
              origin={-42,-50})));
        FiveZoneSim.PrimarySideControl.BaseClasses.TimerGreatEqual timGreEqu(threshold=
             staUpThr) "Timer"
          annotation (Placement(transformation(extent={{-80,70},{-60,90}})));
        FiveZoneSim.PrimarySideControl.BaseClasses.TimeLessEqual timLesEqu(threshold=
             staDowThr) "Timer"
        ...
        Modelica.StateGraph.Transition tra4(
         ...
         "Transition 1" annotation (
            Placement(transformation(
              ...
              rotation=-90,
              origin={0,20})));
        FiveZoneSim.PrimarySideControl.BaseClasses.Timer offTim
          "Timer for the state where equipment is off"
          annotation (Placement(transformation(extent={{18,40},{38,60}})));
        FiveZoneSim.PrimarySideControl.BaseClasses.Timer oneOnTim
          "Timer for the state where only one equipment is on"
          annotation (Placement(transformation(extent={{18,-20},{38,0}})));
        FiveZoneSim.PrimarySideControl.BaseClasses.Timer twoOnTim
...
First implementation.
      ...
      package Validation "Collection of validation models that the base classes of the local controls"
        ...
        model Stage "Test the general stage model"
          ...
          parameter Real staUpThr=0.8 "Staging up threshold";
          parameter Real staDowThr=0.45 "Staging down threshold";
          FiveZoneSim.PrimarySideControl.BaseClasses.Stage sta(
            staUpThr=staUpThr,
            staDowThr=staDowThr,
            waiTimStaUp=300,
            shoCycTim=200)
