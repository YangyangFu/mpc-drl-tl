...
model Guideline36TSup
  ...
  extends FiveZoneVAV.VAVReheat.BaseClasses.PartialOpenLoop(flo(
      cor(T_start=273.15 + 24),
      eas(T_start=273.15 + 24),
      sou(T_start=273.15 + 24),
      wes(T_start=273.15 + 24),
      nor(T_start=273.15 + 24)));
  extends FiveZoneVAV.VAVReheat.BaseClasses.EnergyMeterAirSide(
  ...
  extends FiveZoneVAV.VAVReheat.BaseClasses.ZoneAirTemperatureDeviation(
  ...
  FiveZoneVAV.VAVReheat.Controls.Controller conAHU(
    kMinOut=0.01,
    final pMaxSet=410,
