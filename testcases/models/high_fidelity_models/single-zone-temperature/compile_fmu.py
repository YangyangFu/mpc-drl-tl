...
modelpath = 'SingleZoneVAV.ZoneTemperatureBaseline'
fmu_name = 'SingleZoneTemperatureBaseline'
...
fmupath = compile_fmu(modelpath,[mopath], jvm_args='-Xmx1g',target='cs',version='2.0',compile_to=fmu_name+'.fmu',compiler_options=compiler_options)
# -----------
