...
First implementation.
  ...
  equation
    ...
    connect(hvac.uHea, zer.y) annotation (Line(points={{-42,12},{-58,12},{-58,-110},
            {-79,-110}}, color={0,0,127}));
    annotation (
      experiment(
        StartTime=18316800,
        StopTime=23500800,
...
First implementation.
  ...
  model ZoneTemperatureStepResponse
    "Based on Buildings.Air.Systems.SingleZone.VAV.Examples.ChillerDXHeatingEconomizer."
    ...
    IBPSA.Utilities.IO.SignalExchange.Overwrite oveTSetRooHea(
       u(
        unit="K",
        min=273.15 + 10,
        max=273.15 + 35), description="Heating setpoint")
    ...
    Modelica.Blocks.Sources.CombiTimeTable TSetRooCoo(
      ...
      table=[0,TCooOff;
            ...
            19*3600,TCooOn;
            19*3600,TCooOff;
            24*3600,TCooOff]) "Cooling setpoint for room temperature"
      annotation (Placement(transformation(extent={{-180,-20},{-160,0}})));
    Buildings.Controls.SetPoints.OccupancySchedule occSch
      "Occupancy schedule"
      annotation (Placement(transformation(extent={{-140,80},{-120,100}})));
...
First implementation.
      ...
      Icon(coordinateSystem(extent={{-160,-160},{120,140}}), graphics={
          ...
          Polygon(lineColor = {0,0,255},
                  ...
                  fillPattern = FillPattern.Solid,
                  points={{-52,50},{48,-10},{-52,-70},{-52,50}})}));
  end ZoneTemperatureStepResponse;
