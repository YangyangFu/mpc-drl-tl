...
## ------------
# mopath = 'FiveZone.mo'
# modelpath = 'FiveZone.SystemCoolSeasonBaseline'
# # ------------
...
# fmupath = compile_fmu(modelpath,[mopath], jvm_args='-Xmx8g',target='cs',version='2.0',compile_to='FiveZoneBaseline.fmu',compiler_options=compiler_options)
# -----------

#### Compile FiveZone
# ---------------------
mopath = 'FiveZone.mo'
modelpath = 'FiveZone.wrappedcool'
# ------------
