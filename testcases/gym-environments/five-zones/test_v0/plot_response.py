...
measurement_obc = interpolate_dataframe(measurement_obc[['PHVAC','TRooAirSou','TRooAirEas','TRooAirNor','TRooAirWes','TRooAirCor']],tim_intp)
...
rewards_obc = get_rewards(measurement_obc['PHVAC'].values,measurement_obc[['TRooAirSou','TRooAirEas','TRooAirNor','TRooAirWes','TRooAirCor']].values.T,price_tou,alpha)
...
rewards_obc_last = get_rewards(measurement_obc['PHVAC'].values,measurement_obc[['TRooAirSou','TRooAirEas','TRooAirNor','TRooAirWes','TRooAirCor']].values.T,price_tou,alpha)
