...
def get_args(folder):
    ...
    parser.add_argument('--task', type=str, default="JModelicaCSSingleZoneTemperatureEnv-v2")
...
def test_sac(args):
    ...
    actor = ActorProb(net_a, args.action_shape, max_action=args.max_action, device=args.device, unbounded=True, conditioned_sigma=True).to(args.device)
