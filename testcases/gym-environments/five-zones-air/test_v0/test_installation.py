...
## ====================================================
#    Testing JModelicaCSFiveZoneAirEnv-v0 installation
## ===================================================
simulation_start_time=204*3600*24.
simulation_end_time=204*3600*24.+3600*12.
time_step=15*60.

env = gym.make("JModelicaCSFiveZoneAirEnv-v0",
...
print("(action_space, nActions)")
print(env.action_space.n,env.nActions)
print("alpha:")
print(env.alpha)
...
print("\nJModelicaCSFiveZoneAirEnv-v0 is successfully installed!!" )