...
for sub_dir in sub_dirs:
    data_path = os.path.join(sub_dir, 'log_ddqn', 'JModelicaCSSingleZoneEnv-v1')
    print(data_path)
    ...
    plt.ylabel("Speed")
    plt.xlabel("Time Step")
    plt.savefig(os.path.join(data_path,"final_train.pdf"))
    plt.savefig(os.path.join(data_path,"final_train.png"))
    plt.close()
