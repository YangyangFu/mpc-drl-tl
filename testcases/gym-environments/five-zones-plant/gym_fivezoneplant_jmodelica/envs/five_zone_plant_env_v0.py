...
class JModelicaCSFiveZonePlantEnv(FiveZonePlantEnv, FMI2CSEnv):
    """
    ...
    def __init__(self,
        ...
        super(JModelicaCSFiveZonePlantEnv,self).__init__("./FiveZonePlant.fmu",
