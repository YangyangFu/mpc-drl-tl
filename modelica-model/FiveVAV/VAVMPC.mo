within FiveVAV;
model VAVMPC
  "Variable air volume flow system with terminal reheat and five thermal zones used for MPC design"
  extends Modelica.Icons.Example;
  extends FiveVAV.VAVReheat.BaseClasses.PartialOpenLoop(
      flo(
  ...
  Modelica.Blocks.Interfaces.RealInput yVAV[5] "Signal for VAV damper"
 ...
 Modelica.Blocks.Sources.RealExpression eleSupFan(y=fanSup.P) "Pow of fan"
    annotation (Placement(transformation(extent={{1300,538},{1320,558}})));
  Modelica.Blocks.Interfaces.RealOutput powFan "Value of Real output"
    annotation (Placement(transformation(extent={{1400,538},{1420,558}})));
 Modelica.Blocks.Sources.RealExpression heaCooCoi(y=cooCoi.Q1_flow)
    "Heat flow in cooling coil"
    annotation (Placement(transformation(extent={{1300,510},{1320,530}})));
  Modelica.Blocks.Interfaces.RealOutput qCooCoi "Value of Real output"
...
equation
  ...
  connect(wes.y_actual,conVAVWes.yDam_actual)  annotation (Line(points={{1332,
          ...
          127}));
  connect(yVAV[5], cor.yVAV) annotation (Line(points={{-400,116},{308,116},{308,
          226},{552,226},{552,50},{566,50}}, color={0,0,127}));
  connect(yVAV[1], sou.yVAV) annotation (Line(points={{-400,84},{302,84},{302,232},
          {736,232},{736,48},{746,48}}, color={0,0,127}));
  connect(yVAV[2], eas.yVAV) annotation (Line(points={{-400,92},{298,92},{298,236},
          {912,236},{912,48},{926,48}}, color={0,0,127}));
  connect(yVAV[3], nor.yVAV) annotation (Line(points={{-400,100},{-28,100},{-28,
          102},{304,102},{304,240},{1074,240},{1074,48},{1086,48}}, color={0,0,127}));
  connect(yVAV[4], wes.yVAV) annotation (Line(points={{-400,108},{294,108},{294,
          242},{1274,242},{1274,48},{1286,48}}, color={0,0,127}));
  connect(eleSupFan.y, powFan)
    annotation (Line(points={{1321,548},{1410,548}}, color={0,0,127}));
  connect(heaCooCoi.y, qCooCoi)
    annotation (Line(points={{1321,520},{1410,520}}, color={0,0,127}));
  annotation (
